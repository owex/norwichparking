  ...
  return (
    <DefaultLayout>
      <div className="prose mx-auto">
        ...
        <p>
          At norwichparking.co.uk, accessible from norwichparking.co.uk, one of
          our main priorities is the privacy of our visitors. This Privacy
          Policy document contains types of information that is collected and
          recorded by norwichparking.co.uk and how we use it.
        </p>
        ...
        <p>
          norwichparking.co.uk legal basis for collecting and using the personal
        ...
        <ul>
          <li>norwichparking.co.uk needs to perform a contract with you</li>
          <li>You have given norwichparking.co.uk permission to do so</li>
          <li>
            Processing your personal information is in norwichparking.co.uk
            legitimate interests
          </li>
          <li>norwichparking.co.uk needs to comply with the law</li>
        </ul>

        <p>
          norwichparking.co.uk will retain your personal information only for as
        ...
        <p>
          norwichparking.co.uk follows a standard procedure of using log files.
        ...
        <p>
          Like any other website, norwichparking.co.uk uses "cookies". These
        ...
        <p>
          ...
          advertising partners of norwichparking.co.uk.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on norwichparking.co.uk, which
        ...
        <p>
          Note that norwichparking.co.uk has no access to or control over these
        ...
        <p>
          norwichparking.co.uk's Privacy Policy does not apply to other
        ...
        <p>
          norwichparking.co.uk does not knowingly collect any Personal
        ...
        <p>
          ...
          shared and/or collect in norwichparking.co.uk. This policy is not
